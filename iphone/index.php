...
$query = "SELECT r.review_id, r.content, r.rating, r.created_at, 
...
if (!empty($search)) {
    $query .= " AND (s.store_name LIKE '%$search%' OR r.content LIKE '%$search%' OR s.address LIKE '%$search%')";
}
    ...
    <div class="body">
        ...
        <div class="reviews">
            <?php foreach ($reviews as $review): ?>
                <a href="baidang.php#review-<?php echo $review['review_id']; ?>" class="review-card">
                    <div class="stars">

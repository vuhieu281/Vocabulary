...
<body>
                ...
                <div class="form-group">
                    ...
                    <div class="file-upload-container">
                        <div class="file-upload-button">
                            ...
                            <span class="upload-text">Chọn ảnh để tải lên</span>
                        </div>
                        <div class="file-info-container">
                            <span class="file-info">Chưa có ảnh nào được chọn</span>
                            <small class="file-hint">Chấp nhận: JPG, PNG, GIF (Tối đa 5 ảnh)</small>
                        </div>
    ...
    <script src="assets/js/baidang.js"></script>
</body>
</html>
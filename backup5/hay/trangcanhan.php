                    ...
                    <div id="review-<?php echo $review['review_id']; ?>" class="review-item">
                        ...
                        <div class="review-header">
                            ...
                            <div class="review-actions">
                                <button type="button" class="edit-btn" data-review-id="<?php echo $review['review_id']; ?>">
                        ...
                        <div id="edit-form-<?php echo $review['review_id']; ?>" class="edit-form" style="display:none;">
                            <form id="editReviewForm-<?php echo $review['review_id']; ?>" method="POST" action="update_review.php">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="rating-container">
                                        <input type="hidden" name="rating" id="rating-input-<?php echo $review['review_id']; ?>" value="<?php echo $review['rating']; ?>">
                                        <?php for($i = 5; $i >= 1; $i--): ?>
                                            <span class="rating-star" data-value="<?php echo $i; ?>" data-review-id="<?php echo $review['review_id']; ?>">★</span>
                                        <?php endfor; ?>
                                    </div>
                                </div>
                                <div class="form-group">
